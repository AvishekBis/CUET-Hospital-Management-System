...
class Appointment(models.Model):
    ...
    def __str__(self):
        # ✅ Safe string: avoids NoneType.full_name crashes
        patient_name = getattr(self.patient, "full_name", None) if self.patient else None
        doctor_name = getattr(self.doctor, "full_name", None) if self.doctor else None
...
class MedicalRecord(models.Model):
    ...
    def __str__(self):
        # ✅ Safe string: appointment/patient can be None in some broken rows
        patient = getattr(self.appointment, "patient", None) if self.appointment else None
